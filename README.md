...
이번 추가 구현 묶음은 기존 전달 소스 2cee63b와 이전 검수본 64d9055를 확장한 **1.0 (18)** 개발본입니다. 기존 TestFlight 빌드와 코드가 달라졌으며, 이 개선본을 TestFlight/App Store에 업로드한 상태는 아닙니다. 로컬 AI의 상업 라이선스·판독 품질 및 실제 거래/운영 검증이 남아 있어 출시 준비 완료로 표시하지 않습니다.

공개 과목·공식 평가·진도 정합성, 첫 학습의 서버 저장과 기기 간 복원, 학생의 오늘/학습/Arena/기록/나 흐름, 적응형 문제·메모 작업대, 학원 과제 혼합 OMR·재채점, 교사/관리자 개념 분석, 답지 자료, 계정별 로컬 복구 및 웹 파생 자산 생성 도구를 포함합니다.

## 먼저 읽기

- [추가 기능·실행 증거·아직 미완료인 출시 조건](docs/IMPLEMENTATION_AND_VERIFICATION_0907.md)
