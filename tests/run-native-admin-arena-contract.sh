...
grep -Fq 'GET /api/v1/admin/arena' "$demo"; grep -Fq '/api/v1/admin/arena/integrity/{caseId}/review' "$demo"; grep -Fq '"GOAT Arena 운영"' "$root/Matths/StaffWorkspaceState.swift"
