...
grep -Fq 'TutorialFocusGeometry.contentReserve(viewport:' "$root_view"
grep -Fq 'TutorialFocusGeometry.focusedDimOpacity' "$root_view"
grep -Fq 'TutorialFocusGeometry.transitionalDimOpacity' "$root_view"
grep -Fq 'animated: false' "$root_view"
