...
struct AdminArchiveScreen: View {
    ...
    private var destructiveMessage: String {
        switch destructive {
        case .folder: return "폴더 안에 자료나 하위 폴더가 있으면 삭제할 수 없습니다."
        case .item: return "30일 동안 휴지통에서 복구할 수 있습니다."
        case .purge: return "복구할 수 없으며 저장된 파일도 함께 삭제됩니다."
