...
struct AdminStoreScreen: View {
    ...
    private var deleteMessage: String { switch deletion { case .hall: "사용자에게 즉시 숨기고 데이터는 보관합니다."; case .product: "상품과 연결된 저장 파일을 복구할 수 없게 삭제합니다."; case .category: "연결된 상품이 있으면 카테고리를 삭제할 수 없습니다."; case nil: "" } }
