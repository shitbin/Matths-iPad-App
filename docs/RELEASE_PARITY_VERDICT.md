...
> **역사적 판정:** 아래 표는 clean `64d9055` 시점의 1.0(17) 결과입니다. 그 뒤 추가된 서버/iOS 구현과 현재 남은 조건은 [추가 구현과 검증 상태](IMPLEMENTATION_AND_VERIFICATION_0907.md)를 확인하세요. 특히 아래 126개 검사·Release 성공·서버 읽기 전용·온보딩 서버 미구현 표기는 최신 변경분의 상태가 아닙니다.
