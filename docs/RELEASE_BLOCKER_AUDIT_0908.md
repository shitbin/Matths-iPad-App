...
> 역사적 감사입니다. 2026-09-10 build 22에서 판독 모델을 Apache-2.0 Qwen3.5-2B로
> 교체했습니다. 현재 모델 상태는 [모델 교체 기록](MODEL_REPLACEMENT_0910.md)을
> 확인하세요. 아래의 3B 사용권 미확인 문구를 새 모델의 문제로 재사용하지 않습니다.
